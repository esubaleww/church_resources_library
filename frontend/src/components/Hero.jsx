...
export default function Hero({ scrollToSection }) {
  ...
  return (
    <section
      id="home"
      className="relative overflow-hidden bg-black dark:bg-slate-950"
    >
    ...
    bg-[radial-linear(circle_at_top_right,rgba(251,191,36,0.32),transparent_55%),
         radial-linear(circle_at_bottom_left,rgba(139,92,246,0.15),transparent_45%)]
    dark:bg-[radial-linear(circle_at_top_right,rgba(251,191,36,0.22),transparent_55%),
           radial-linear(circle_at_bottom_left,rgba(139,92,246,0.08),transparent_45%)]"
        />

        <div className="pointer-events-none absolute inset-0 opacity-[0.015] dark:opacity-[0.008]">
          <div
            className="absolute top-1/4 left-1/4 w-32 h-32 
                border-2 border-amber-300/20 dark:border-amber-400/10 rounded-full"
          />
          <div
            className="absolute bottom-1/3 right-1/3 w-24 h-24 
                border border-amber-200/15 dark:border-amber-300/10 rounded-full"
          />
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-[1.15fr_0.85fr] gap-14 items-center w-full">
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                ...
                drop-shadow-[0_0_32px_rgba(250,204,21,0.9)]
                dark:drop-shadow-[0_0_32px_rgba(251,191,36,0.7)]"
                  />
                </div>
  ...
  shadow-2xl shadow-amber-900/60 dark:shadow-amber-900/40
  hover:shadow-3xl hover:shadow-amber-900/70 dark:hover:shadow-amber-900/50
  ...
  backdrop-blur-xl
  shadow-[0_24px_80px_rgba(0,0,0,0.55)] dark:shadow-[0_24px_80px_rgba(0,0,0,0.75)]
  overflow-hidden
